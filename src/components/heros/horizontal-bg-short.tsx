...
export default function HorizontalBgShort() {
    return (
        <main className="bg-primary/20">
            <div className="px-4 sm:px-0 max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between gap-16 items-center py-16">
                <div className="flex flex-col">
                    <p className="px-4 text-xs mb-4 py-1 w-fit rounded-full border border-foreground/25">Cool Label</p>
